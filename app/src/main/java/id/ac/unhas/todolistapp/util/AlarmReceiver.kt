...
class AlarmReceiver: BroadcastReceiver() {
    ...
    private fun showReminderNotification(context: Context, title: String, todo: String?, notifId: Int) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val notificationChannel = NotificationChannel(channeId, channelName, NotificationManager.IMPORTANCE_HIGH)
